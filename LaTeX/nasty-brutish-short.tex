...
During the 2016 U.S. presidential elections, social media played a large role in both the creation and propogation of stories. In particular, Twitter served as an important platform for the spread of news articles, which have significant influence on public opinion. Yet the sharing of content is often based on innate emotional triggers that are seldom rational. In our research, we seek to examine whether the emotional vocabulary of political news stories can lead to their popularity, and if those patterns persist across different political groupings on Twitter. To do so, we construct a corpora of 2,650 news stories collected by scraping the websites of 13 different news organizations over 5 months. We then match these stories to all tweets that contain a link to them, resulting in 123,113 tweets by 20,964 Twitter users. By using automated content analysis based on the Harvard Inquirer lexicons, we code stories for their emotionality and positivity. We run regressions between the independent variables of story length, emotionality, and positivity and the dependent variable of number of shares across 7 different political divisions of Twitter users, as well as the collective dataset. On the whole, we find Twitter users to favor stories that are Hobbesian in nature: nasty (negative in positivity), brutish (high in emotionality), and short (low in word count). These patterns persist across political divides.
